...
<div id="main-container" class="admin_container">
  ...
  <style type="text/css">
	...
	.wx_menu .keyboard{ float:left; width:44px;height:50px; background:url(/Public/Home/images/wx_menu_keyboard_icon.png) no-repeat; background-size:100% 100%; border-right:1px solid #CCC;}
	...
	.wx_menu .sub_menu em{ position:absolute; width:10px; height:8px; bottom:-7px; left:50%; margin-left:-5px; background:url(/Public/Home/images/arrow_down.png) no-repeat center bottom;}
  </style>
                	...
                	<div class="wx_menu">
                        ...
                        <div class="menu">
                        	 <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i; if(($data[pid]) == "0"): ?><div class="m_a"  href="javascript:;">
                                    	<div class="m_a_i">
                                       	  <img src="/Public/Home/images/wx_menu_list_icon.png"/><?php echo ($data["title"]); ?>
                                        </div>
                                        <div class="sub_menu">
