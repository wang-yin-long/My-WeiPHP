    ...
    <section id="contents"> 
      <div class="table-bar">
        ...
        <div class="search-form fr cf">
          <input type="text" placeholder="请输入礼包名称搜索" value="<?php echo I('title');?>" class="search-input" name="title">
          ...
          <table cellspacing="1">
            ...
            <thead>
              <tr>
                ...
                <th width='20%'>礼包名称</th>
                <th width='13%'>状态</th>
                <th width='10%'>大礼包总数</th>
                <th width='10%'>大礼包领取数</th>
                <th width='10%'>分享要求</th>
                <th width='10%'>领取总数</th>
                <th width='30%'>有效期</th>
              </tr>
            ...
            <tbody>
              <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td type="title"><?php echo ($vo["title"]); ?></td>
                   ...
                   <td type="prize_num"><?php echo ($vo["prize_num"]); ?></td>
                   <td type="collect_num"><?php echo ($vo["collect_num"]); ?></td>
                   <td type="start_time"><?php echo ($vo["limit_num"]); ?></td>
                   <td type="total"><?php echo ($vo["total"]); ?></td>
                   <td type="start_time"><?php echo ($vo["start_time"]); ?></td>
